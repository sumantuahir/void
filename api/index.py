...
def init_db():
    ...
    # Seed Mock Visitors (only if empty)
...
if __name__ == '__main__':
    ...
    if not DB_URL:
        ...
        exit(1)
    init_db()
    print(f"Starting server locally on port {PORT} with database Supabase...")
